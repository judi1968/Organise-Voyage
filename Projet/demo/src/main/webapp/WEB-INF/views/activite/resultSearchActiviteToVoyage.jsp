<%@ page import="judi.example.demo.Models.DataObject.ActiviteVoyageResultSearch" %>
<%
    ActiviteVoyageResultSearch[] resultats = (ActiviteVoyageResultSearch[])request.getAttribute("resultat");
%>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Bouquet - Resultat de recherche des activites dans un voyage</title>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <% for (ActiviteVoyageResultSearch activiteVoyageResultSearch : resultats) { %>
                    <tr>
                      <td><%= activiteVoyageResultSearch.getVoyage().getNom_voyage() %></td>
                      <td><%= activiteVoyageResultSearch.getDurre().getNom() %></td>
                      <td><%= activiteVoyageResultSearch.getNombre_activite() %></td>
                      </tr>
                    <% } %>
                  </tbody>
                </table>
