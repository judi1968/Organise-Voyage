<%@ page import="judi.example.demo.Models.Objects.Voyage" %>
<%@ page import="judi.example.demo.Models.Objects.Durre" %>
<%@ page import="judi.example.demo.Models.Objects.Activite" %>

<%
    Voyage voyage = (Voyage)request.getAttribute("voyage");
    Durre[] durres = (Durre[])request.getAttribute("durres");
...
<head>
  ...
  <title>Ajouter un durre de voyage</title>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="pagetitle col-lg-6" style="margin-top: 5%; margin-left: 2%;">
          <h1>Ajout de durre d'activite dans le voyage</h1>
        </div><!-- End Page Title -->
        <div class="col-lg-3"></div>
        </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="card" style="margin-top: 0%;">
                      <div class="card-body">
                        <h5 class="card-title">Ajouter le durrer de l'activite</h5>
          
                        <!-- General Form Elements -->
                        <form action="/ajout_activite_durre_traitement" method="post">
                          <div class="row mb-3">
                            <h1> <%= voyage.getNom_voyage() %></h1>
                          </div>
                          <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Durre</label>
                            <div class="col-sm-10">
                              <select class="form-select" aria-label="Default select example" name="id_duree">
                                <% for (Durre durre : durres) { %>
                                  <option value="<%= durre.getId() %>"><%= durre.getNom() %></option>
                                <% } %>
                              </select>
                            </div>
                          </div>
                        ...
                        <div class="col-sm-10">
                          <select class="form-select" aria-label="Default select example" name="id_activite">
                            <% for (Activite activite : activites) { %>
                              <option value="<%= activite.getId_activite() %>"><%= activite.getNom_activite() %></option>
                            <% } %>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-10">
                        <input type="hidden" name="id_voyage" value="<%= voyage.getId_voyage() %>">
