<%@ page import="judi.example.demo.Models.Objects.ActiviteVoyage" %>
<%
    ActiviteVoyage[] voyages = (ActiviteVoyage[])request.getAttribute("voyage");
%>
<!DOCTYPE html>
<html lang="en">
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-sm-10">
                      <select class="form-select" aria-label="Default select example" name="id_voyage">
                        ...
                        <% for (ActiviteVoyage activiteVoyage : voyages) { %>
                            <option value="<%= activiteVoyage.getVoyage().getId_voyage()+";"+activiteVoyage.getDurre().getId()  %>"><%= activiteVoyage.getVoyage().getNom_voyage()+" - "+activiteVoyage.getDurre().getNom()%></option>
                        <% } %>
                      </select>
                    </div>
