...
<%
    Voyage[] voyages = (Voyage[])request.getAttribute("voyage");
%>
<!DOCTYPE html>
<html lang="en">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Liste de tout les voyages</h5>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <% int i = 0 ; for (Voyage voyage : voyages) { %>
                        <tr>
                          <th scope="row"><%= i+1 %></th>
                          <td><%= voyage.getNom_voyage() %></td>
                          <td><%= voyage.getLieu().getNom() %></td>
                          <td><%= voyage.getBouquet().getNom_bouquet() %></td>
                          <td><a href="/ajouter_durre_activite_to_voyage?id_voyage=<%= voyage.getId_voyage() %>" title="Ajouter des activites"><i class="bi bi-plus-circle" style="color: rgb(93, 93, 255); font-size: x-large; "></i></a></td>
                        </tr>
                        <% i++ ; } %>
                  </tbody>
                </table>
