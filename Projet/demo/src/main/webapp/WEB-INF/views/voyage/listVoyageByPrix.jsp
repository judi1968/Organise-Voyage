<%@ page import="judi.example.demo.Models.DataObject.Voyage_prix" %>
<%@ page import="judi.example.demo.Models.Objects.Voyage" %>

<%
    Voyage_prix[] voyage = (Voyage_prix[])request.getAttribute("resultat");
%>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Voyage - liste par prix</title>
              ...
              <div class="card-body">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                      ...
                      <% for (Voyage_prix voyage_prix : voyage) { %>
                        <tr>
                          <td><%= voyage_prix.getNom_voyage() %> </td>
                          <td><%= voyage_prix.getPrix() %> </td>   
                            </tr>
                      <% } %>
