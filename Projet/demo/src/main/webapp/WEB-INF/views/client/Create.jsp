<%@ page import="judi.example.demo.Models.Objects.Genre" %>
<%
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="card" style="margin-top: 0%;">
            <div class="card-body">
              <h5 class="card-title">Creer un client</h5>
              ...
              <div class="col-sm-10">
                <select class="form-select" aria-label="Default select example" name="genre">
                  ...
                  <% for (Genre genre : genres) { %>
                    <option value="<%= genre.getId_genre() %>"><%= genre.getdesignation_genre() %></option>
                  <% } %>
                </select>
              </div>
