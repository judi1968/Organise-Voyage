...
<head>
  ...
  <title>Fonction employe - liste</title>
    ...
    <section class="section dashboard">
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Creer Fonction</h5>
  
                <!-- General Form Elements -->
                <form method="post" action="/insertFonctionEmploye">
                  <div class="row mb-9">
                    <label for="inputText" class="col-sm-2 col-form-label">Nom de fonction</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control"name="nom_designation">
                    </div>
                  </div>
                  <div class="row mb-4">
                    <div class="col-sm-10">
              ...
              <div class="card-body">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><%= fonctionEmploye.getNom_designation() %></td>
                    </tr>
                    <% } %>
                  </tbody>
                </table>
